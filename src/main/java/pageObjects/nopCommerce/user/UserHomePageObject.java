...
public class UserHomePageObject extends BasePage {
	...
	public boolean isMyAccoutDisplayed() {
		waitForElementVisible(driver, HomePageUI.MY_ACCOUT_LINK);
		return isElementDisplayed(driver, HomePageUI.MY_ACCOUT_LINK);
	}
	@Step("Navigate to My Account page")
	public UserCustomerInforPageObject openMyAccountPage() {
		waitForElementClickable(driver, HomePageUI.MY_ACCOUT_LINK);
