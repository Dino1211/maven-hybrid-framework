...
public class AdminPostAddNewPO extends BasePage {
	...
	public void enterToEditPostBody(String postBodyValue) {
		...
		waitForElementVisible(driver, AdminPostAddNewPageUI.BODY_TEXTBOX);
		clearValueInElementDeleteKey(driver, AdminPostAddNewPageUI.BODY_TEXTBOX);
		sleepInSecond(3);
		senkeyToElement(driver, AdminPostAddNewPageUI.BODY_TEXTBOX, postBodyValue);
	...
	public boolean isPostPublishMessageDisplayed(String postPublishedMessage) {
		waitForElementVisible(driver, AdminPostAddNewPageUI.PUBLISHED_MESSAEG, postPublishedMessage);
		return isElementDisplayed(driver, AdminPostAddNewPageUI.PUBLISHED_MESSAEG, postPublishedMessage);
	}
