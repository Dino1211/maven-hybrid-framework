...
public class UserHomePO extends BasePage {
	...
	public boolean isPostInforUnDisplayedWithPostTitle(String editPostTitel) {
		return isElementUndisplayed(driver, UserHomePageUI.POST_TITLE_TEXT, editPostTitel);
	}

	public void enterToSearchTextbox(String editPostTitel) {
		waitForElementVisible(driver, UserHomePageUI.SEARCH_TEXTBOX);
		senkeyToElement(driver, UserHomePageUI.SEARCH_TEXTBOX, editPostTitel);
