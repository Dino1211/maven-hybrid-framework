...
public class BasePageNopcommerceUI {
	...
	public static final String LOGOUT_AT_ADMIN= "xpath=//a[text()='Logout']";
	public static final String LOGOUT_AT_USER= "css=//a[class='ico-logout']";
	
	// Pattern Object
	public static final String DYNAMIC_AT_MY_ACCOUNT_AREA="XPath=//div[contains(@class,'account-navigation')]//a[text()='%s']";
