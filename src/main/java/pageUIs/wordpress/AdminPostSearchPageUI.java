...
public class AdminPostSearchPageUI {
	...
	public static final String TABLE_HEADER_INDEX_BY_HEADER_NAME = "xpath=//table[contains(@class,'table-view-list posts')]//th[@id='title']/preceding-sibling::*";
	...
	public static final String ACTION_DROPDOWN = "css=bulk-action-selector-top";
	public static final String APPLY_BUTTON = "css=#doaction";
	public static final String MOVE_TO_TRASH_MESSAGE = "xpath=//div[@id='message']/p[contains(text(),'%s')]";
	public static final String NOT_FOUND_MESSAGE = "xpath=//table[contains(@class,'table-view-list posts')]//tbody/tr/td[contains(text(),'%S')]";
