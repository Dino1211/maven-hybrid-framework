...
public class HomePageUI {
	...
	public static final String PAGEGINATION_PAGE_BY_INDEX = "XPATH=//ul[@class='qgrd-pagination-ul']/li[@class='qgrd-pagination-page'][1]/a";
	public static final String ALL_ROW_EACH_PAGE = "xpath=//tbody/tr";
	public static final String ALL_ROW_COUNTRY_EACH_PAGE = "XPATH = //tbody/tr/td[@data-key='country']";
	
	// index cua cot ma minh can ente/click/select vao
	...
	public static final String ICON_NAME_BY_ROWNAME = "XPATH=//tbody/tr[%s]//button[@title='%s']";
